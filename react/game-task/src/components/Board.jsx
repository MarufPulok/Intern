    ...
    <>
      ...
      {gameWon && (
        <>
          ...
          <PopUp text="You Won!" onClick={handleNewGameStart} score={score} target={target} attempt={attempt}/>
        </>
      )}
      ...
      {gameLost && (
        <>
          ...
          <PopUp text="You Lose!" onClick={handleNewGameStart} score={score} target={target} attempt={attempt}/>
        </>
      )}
    </>
  );
